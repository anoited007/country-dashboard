...
def geo_profile(geoid, acs='latest'):
    ...
    for item_level in item_levels:
        ...
        if name == 'this':
            ...
            doc['geography'][name]['total_population'] = _maybe_int(
                data['data'][the_geoid]['B01001']['estimate']['B01001001'])
        else:
            doc['geography']['parents'][name] = convert_geography_data(geoid_data)
            doc['geography']['parents'][name]['total_population'] = _maybe_int(
                data['data'][the_geoid]['B01001']['estimate']['B01001001'])
    ...
    poverty_dict['percent_below_poverty_line'] = build_item('Persons below poverty line', data, item_levels,
                                                            'B17001002 B17001001 / %')
    add_metadata(poverty_dict['percent_below_poverty_line'], 'B17001',
                 'Population for whom poverty status is determined', acs_name)
    ...
    add_metadata(employment_dict['mean_travel_time'], 'B08006, B08013',
                 'Workers 16 years and over who did not work at home', acs_name)
    ...
    add_metadata(migration_dict['moved_since_previous_year'], 'B07003',
                 'Population 1 year and over in the United States', acs_name)
    ...
    add_metadata(attainment_dict['percent_high_school_grad_or_higher'], 'B15002', 'Population 25 years and over',
                 acs_name)
    ...
    add_metadata(attainment_dict['percent_bachelor_degree_or_higher'], 'B15002', 'Population 25 years and over',
                 acs_name)
    ...
    language_dict['percent_non_english_at_home'] = build_item('Persons with language other than English spoken at home',
                                                              data, item_levels,
